...
<div style="font-family: Arial, sans-serif; font-size: 9pt; color: #000; max-width: 8.27in; margin: 0 auto; border: 1px solid #000; padding: 0;">
    ...
    <!-- Bottom section with precisely aligned columns -->
    <table style="width: 100%; border-collapse: collapse; font-size: 8pt; margin-bottom: 0; table-layout: fixed;">
        <!-- Row 1: Total in words and Add -->
        <tr>
            <td style="width: 65%; border-left: 1px solid #000; border-right: 1px solid #000; border-bottom: 1px solid #000; padding: 1px 5px; vertical-align: top;">
                <p style="margin: 0;"><strong>Total in words:</strong> {{ doc.in_words }}</p>
            </td>
            <td style="width: 35%; border-right: 1px solid #000; border-bottom: 1px solid #000; padding: 1px 5px; text-align: right; vertical-align: top;">
                <p style="margin: 0; font-weight: bold;">Add:</p>
            </td>
        </tr>
    </table>
    
    <!-- Bank Details and Charges -->
    <table style="width: 100%; border-collapse: collapse; font-size: 8pt; margin-bottom: 0; table-layout: fixed;">
        <tr>
            <td style="width: 65%; border-left: 1px solid #000; border-right: 1px solid #000; border-bottom: 1px solid #000; padding: 1px 5px; vertical-align: top;">
            ...
            <td style="width: 35%; padding: 0; vertical-align: top; border-right: 1px solid #000; border-bottom: 1px solid #000;">
                <!-- Nested table for charges to align with total column -->
                <table style="width: 100%; border-collapse: collapse; font-size: 7pt; line-height: 1;">
                    <tr style="border-bottom: 1px solid #000;">
                        <td style="padding: 1px 5px; text-align: left; border-right: 1px solid #000; width: 57.14%;">Freight Charges</td>
                        <td style="padding: 1px 5px; text-align: right; width: 42.86%;">{{ "{:,.2f}".format(doc.freight_charges or 0) }}</td>
                    </tr>
                    <tr style="border-bottom: 1px solid #000;">
                        <td style="padding: 1px 5px; text-align: left; border-right: 1px solid #000; width: 57.14%;">Misc Charges</td>
                        <td style="padding: 1px 5px; text-align: right; width: 42.86%;">{{ "{:,.2f}".format(doc.misc_charges or 0) }}</td>
                    </tr>
                    <tr style="border-bottom: 1px solid #000;">
                        <td style="padding: 1px 5px; text-align: left; border-right: 1px solid #000; width: 57.14%;">Taxable Value</td>
                        <td style="padding: 1px 5px; text-align: right; width: 42.86%;">{{ "{:,.2f}".format(doc.net_total) }}</td>
                    </tr>
                    <tr style="border-bottom: 1px solid #000;">
                        <td style="padding: 1px 5px; text-align: left; border-right: 1px solid #000; width: 57.14%;">CGST</td>
                        <td style="padding: 1px 5px; text-align: right; width: 42.86%;">
                            {% set cgst_amount = 0 %}
                    ...
                    <tr style="border-bottom: 1px solid #000;">
                        <td style="padding: 1px 5px; text-align: left; border-right: 1px solid #000; width: 57.14%;">SGST</td>
                        <td style="padding: 1px 5px; text-align: right; width: 42.86%;">
                            {% set sgst_amount = 0 %}
                            {% for tax in doc.taxes %}
                    ...
                    <tr>
                        <td style="padding: 1px 5px; text-align: left; font-weight: bold; border-right: 1px solid #000; width: 57.14%;">Total Invoice value</td>
                        <td style="padding: 1px 5px; text-align: right; font-weight: bold; width: 42.86%;">{{ "{:,.2f}".format(doc.grand_total) }}</td>
                    </tr>
                </table>
            </td>
        </tr>
    ...
    <table style="width: 100%; border-collapse: collapse; font-size: 8pt; margin-bottom: 0; table-layout: fixed;">
        <tr>
            ...
            <td style="width: 35%; border-right: 1px solid #000; border-bottom: 1px solid #000; padding: 1px 5px; vertical-align: top;">
